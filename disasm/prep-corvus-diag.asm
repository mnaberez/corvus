...
;
    call host_read      ;A = read 1 byte from the host
    ld (l81fd),a        ;806c 32 fd 81
    ld hl,0000h         ;806f 21 00 00
    ld (l81fe),hl       ;8072 22 fe 81
    rst 10h             ;8075 d7
...
;
    ...
    ld (l81fd),a        ;80ad 32 fd 81
    ld hl,0000h         ;80b0 21 00 00
    ld (l81fe),hl       ;80b3 22 fe 81
l80b6h:
...
sub_810dh:
    ...
    rrca                ;8112 0f
    ld b,a              ;8113 47
    ld a,(l81fd)        ;8114 3a fd 81
    and 0e0h            ;8117 e6 e0
    add a,20h           ;8119 c6 20
    ld (l81fd),a        ;811b 32 fd 81
    cp b                ;811e b8
    jr c,l8138h         ;811f 38 17
    xor a               ;8121 af
    ld (l81fd),a        ;8122 32 fd 81
    ld hl,(l81fe)       ;8125 2a fe 81
    inc hl              ;8128 23
    ld (l81fe),hl       ;8129 22 fe 81
    ex de,hl            ;812c eb
...
l8147h:
    ...
    ld (hl),a           ;815f 77
    inc hl              ;8160 23
    ld bc,(l81fe)       ;8161 ed 4b fe 81
    ld (hl),c           ;8165 71
    inc hl              ;8166 23
    ld (hl),b           ;8167 70
    inc hl              ;8168 23
    ld a,(l81fd)        ;8169 3a fd 81
    and 1fh             ;816c e6 1f
    ld (hl),a           ;816e 77
    inc hl              ;816f 23
